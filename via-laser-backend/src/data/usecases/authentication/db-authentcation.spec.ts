...
describe('DbAuthentication UseCase', () => {
  ...
  test('Should throw with LoadAccountByEmailRepository throws', async () => {
    const { sut, loadAccountEmailByRepositoryStub } = makeSut()
    jest.spyOn(loadAccountEmailByRepositoryStub, 'loadByEmail').mockReturnValueOnce(new Promise((resolve, reject) => reject(new Error())))
  ...
  test('Should return null if LoadAccountByEmailRepository return null', async () => {
    const { sut, loadAccountEmailByRepositoryStub } = makeSut()
    jest.spyOn(loadAccountEmailByRepositoryStub, 'loadByEmail').mockReturnValueOnce(null)
  ...
  test('Should throw with UpdateAccessTokenRepository throws', async () => {
    const { sut, updateAccessTokenRepositoryStub } = makeSut()
